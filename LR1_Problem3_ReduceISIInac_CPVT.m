...
figure;
sgtitle(['LR1 Model + 0.5 * \beta_f, w/', num2str(max(vars.stim)), '\muA/cm^2 Injection for ',num2str(inj1(3)-inj1(2)), 'ms @ t=', num2str(inj1(2)), 'ms'], FontSize=15)
...
hold off;
legend("Normal V_m","V_m with mutation", FontSize=13)
